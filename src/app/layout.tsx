  ...
  return (
    <footer className="row-start-3 p-4 text-xs font-bold flex gap-6 flex-wrap items-center justify-center">
      <div className="flex divide-x gap-4">
        <div className="pl-4 first:pl-0">ABN: 27 488 015 405</div>
        <div className="pl-4 first:pl-0">Email: juliuscarvajal21@gmail.com</div>
        <Link
          href="/projects"
          className="underline underline-offset-4 pl-4 first:pl-0"
        >
